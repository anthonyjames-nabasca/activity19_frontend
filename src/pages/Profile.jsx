          ...
          <main className="main-content">
            <div className="topbar">
              <div className="topbar-left">
                ...
                <p>Manage your personal information and account visibility.</p>
              </div>

              <div className="topbar-right" ref={menuRef}>
                <div className="avatar-chip" onClick={() => setMenuOpen((prev) => !prev)}>
                  {user.profile_image ? (
                ...
                {menuOpen && (
                  <div className="profile-menu">
                    <div className="profile-menu-top">
                      ...
                      <p className="profile-menu-name">{user.fullname}</p>
                    </div>
            ...
            <section className="cards-grid">
              ...
              <div className="stat-card">
                <div className="stat-card-top green">
                  ...
                  <div className="stat-circle">{user.is_verified ? "✓" : "!"}</div>
                </div>
                <div className="stat-card-body">
                  {user.is_verified
              ...
              <div className="stat-card">
                <div className="stat-card-top orange">
                  ...
                  <p>Your active login identity in the current session.</p>
            ...
            <section className="content-grid">
              <div className="panel profile-summary">
                ...
                <p className="summary-name">{user.fullname}</p>
                ...
                <div className="mini-stats">
                  ...
                  <div className="mini-stat-box">
                    <div className="mini-stat-label">Accounts</div>
                    <div className="mini-stat-value">{accountCount}</div>
                  </div>
                </div>
              </div>
