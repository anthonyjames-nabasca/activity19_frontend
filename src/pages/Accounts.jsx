...
export default function Accounts() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editingId) {
        res = await api.put(`/api/account/${editingId}`, data, {
          ...
          <main className="main-content">
            <div className="topbar">
              <div className="topbar-left">
                ...
                <p>Create, edit, delete, and organize your saved account items.</p>
              </div>
            ...
            <section className="form-panel">
              <h3>{editingId ? "Edit Account Item" : "Create New Account Item"}</h3>
            ...
            <section className="cards-grid">
              ...
              {items.length === 0 && (
                <div className="account-card" style={{ gridColumn: "1 / -1" }}>
                  <div className="account-card-body">
                    <h3>No account items yet</h3>
                    <p>Create your first saved account using the form above.</p>
                  </div>
                </div>
              )}
            </section>
